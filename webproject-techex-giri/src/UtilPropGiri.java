...
public class UtilPropGiri {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\14022\\Downloads\\Software Engineering\\workspaceCSCI4830-techex-giri\\webproject-techex-giri\\WebContent\\WEB-INF\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject-techex-giri/config.properties";
